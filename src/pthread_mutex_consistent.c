...
INLINE int ptw32_robust_mutex_inherit(pthread_mutex_t* mutex) {
    int result;
...
INLINE void ptw32_robust_mutex_add(pthread_mutex_t* mutex, pthread_t self) {
...
INLINE void ptw32_robust_mutex_remove(pthread_mutex_t* mutex, ptw32_thread_t* otp) {
    ptw32_robust_node_t** list;
    pthread_mutex_t mx = *mutex;
    ptw32_robust_node_t* robust = mx->robustNode;
