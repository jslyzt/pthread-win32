 ...
 */
BOOL ptw32_oll_ShouldArriveAtTree() {
    return PTW32_FALSE;
}
 ...
 */
ptw32_oll_ticket_t ptw32_oll_Arrive(ptw32_oll_csnzi_t* csnzi) {
    for (;;) {
 ...
 */
BOOL ptw32_oll_Depart(ptw32_oll_ticket_t ticket) {
 ...
 */
BOOL ptw32_oll_TreeArrive(ptw32_oll_snziNodeOrRoot_t snziNodeOrRoot) {
 ...
 */
BOOL ptw32_oll_TreeDepart(ptw32_oll_snziNodeOrRoot_t snziNodeOrRoot) {
    if (snziNodeOrRoot.nodePtr->counter.internal.root != ptw32_oll_snzi_root) {
        /* Non-root node */
        ptw32_oll_counter_t newCounter, oldCounter;
        do {
 ...
 */
void ptw32_oll_Open(ptw32_oll_csnzi_t* csnziPtr) {
 ...
 */
void ptw32_oll_OpenWithArrivals(ptw32_oll_csnzi_t* csnziPtr, size_t count, BOOL close) {
 ...
 * zero.
 */
BOOL ptw32_oll_Close(ptw32_oll_csnzi_t* csnziPtr) {
    ptw32_oll_snziRoot_t newProxy, oldProxy;
    do {
 ...
 * OPEN to CLOSED.
 */
BOOL ptw32_oll_CloseIfEmpty(ptw32_oll_csnzi_t* csnziPtr) {
    ptw32_oll_snziRoot_t newProxy, oldProxy;
    do {
        oldProxy = csnziPtr->proxyRoot;
 ...
 */
ptw32_oll_queryResult_t ptw32_oll_Query(ptw32_oll_csnzi_t* csnziPtr) {
 ...
 */
BOOL ptw32_oll_Arrived(ptw32_oll_ticket_t t) {
 ...
 */
ptw32_oll_ticket_t ptw32_oll_DirectTicket(ptw32_oll_csnzi_t* csnziPtr) {
    ptw32_oll_ticket_t ticket;
...
ptw32_srwl_node_t* ptw32_srwl_AllocReaderNode(ptw32_srwl_local_t* local) {
 ...
 */
void ptw32_srwl_FreeReaderNode(ptw32_srwl_node_t* nodePtr) {
nodePtr->allocState : = ptw32_srwl_free;
}

void ptw32_srwl_WriterLock(ptw32_srwl_rwlock_t* lockPtr, ptw32_srwl_local_t* localPtr) {
...
void ptw32_srwl_WriterUnlock(ptw32_srwl_rwlock_t* lockPtr, ptw32_srwl_local_t* localPtr) {
...
void ptw32_srwl_ReaderLock(ptw32_srwl_rwlock_t* lockPtr, ptw32_srwl_local_t* localPtr) {
...
void ptw32_srwl_ReaderUnlock(ptw32_srwl_rwlock_t* lockPtr, ptw32_srwl_local_t* localPtr) {
